;(function () {
  ...
  const markdownSourseElement =  document.querySelector('#markdown-source');
  const markdownResultElement =  document.querySelector('#markdown-result');

  markdownSourseElement.value = `## Заголовок статьи
  ...
  markdownSourseElement.addEventListener('keyup', function () {
    const result = marked(markdownSourseElement.value)
